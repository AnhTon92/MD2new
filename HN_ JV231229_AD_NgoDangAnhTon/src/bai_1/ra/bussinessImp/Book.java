...
// phương thức thêm tác giả vào danh sách
    ...
    public void chooseAuthor() {
        ...
        System.out.println("Chọn 1 tác giả từ danh sách sau: ");
        for (int i = 0; i < authorsList.size() ; i++) {
            Author author = authorsList.get(i);
            System.out.println((i+1) + ". Mã: "+ author.getAuthorId() + " - Tên: "
            + author.getAuthorName());
        }
        Scanner scanner = new Scanner(System.in);
        System.out.println("Nhập số thứ tự của tác giả bạn chọn: ");
